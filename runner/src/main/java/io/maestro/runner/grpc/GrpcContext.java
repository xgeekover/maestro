...
import io.maestro.runner.engine.InMemoryKeyValueStore;
 ...
 * {@link #deliver}로 라우팅된다. 상태(state)는 Phase 4에서 러너 인메모리(재시작 간 영속은 후속).
 */
public final class GrpcContext implements ScriptContext {
    ...
    public GrpcContext(String name, Map<String, String> params, StreamSender sender) {
        this.sender = sender;
